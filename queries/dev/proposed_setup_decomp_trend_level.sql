with filtered as (
    select cohort_month, 'L' || cast(management_level as varchar) as group_label, management_level as sort_key, days_to_first_pr
...
contributions as (
    ...
    group by 1, 2, s.selected_hires, st.total_hires, r.reference_hires, rt.total_hires, r.reference_metric_value, s.selected_metric_value
),
ranked as (
    select
        *,
