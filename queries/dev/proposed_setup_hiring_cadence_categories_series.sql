...
select cadence_category, sort_order, 'Median' as series, median_days_to_first_pr as days from summary
union all
select cadence_category, sort_order, 'Average' as series, average_days_to_first_pr as days from summary
union all
select cadence_category, sort_order, 'P25' as series, p25_days_to_first_pr as days from summary
union all
select cadence_category, sort_order, 'P75' as series, p75_days_to_first_pr as days from summary
