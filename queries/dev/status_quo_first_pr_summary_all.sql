...
select cohort_date, 'Median' as series, median_days_to_first_pr as days from cohorts
union all
select cohort_date, 'Average' as series, average_days_to_first_pr as days from cohorts
union all
select cohort_date, 'P25' as series, p25_days_to_first_pr as days from cohorts
union all
select cohort_date, 'P75' as series, p75_days_to_first_pr as days from cohorts
order by 1, 2
